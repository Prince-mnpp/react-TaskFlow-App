    ...
    <>
      ...
      <div className='flex items-center justify-between mb-4'>
        ...
        <div className='flex items-center gap-3'>
          ...
          <div>
            <h1 className='text-3xl font-black text-white tracking-tight'>Task Flow</h1>
      ...
      <div className='relative'>
        ...
        <div className='relative w-full h-2 bg-white/10 rounded-full overflow-hidden'>
          <div className='absolute inset-0 bg-linear-to-br from-emerald-400 via-teal-400 to-cyan-400 rounded-full transition-all duration-700 ease-out shadow-lg' style={{width:`${progress}%`}}></div>
